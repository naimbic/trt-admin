            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Carousel',
                        translateKey: 'nav.uiComponentsDataDisplay.carousel',
                        icon: 'uiDataDisplayCarousel',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey:
                                    'nav.uiComponentsDataDisplay.carouselDesc',
                ...
                subMenu: [
                    {
                        ...
                        path: `${UI_COMPONENTS_PREFIX_PATH}/charts`,
                        title: 'Charts',
                    ...
                    },
                    {
                        ...
                        path: `${UI_COMPONENTS_PREFIX_PATH}/maps`,
                        title: 'Maps',
