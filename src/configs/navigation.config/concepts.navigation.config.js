...
const conceptsNavigationConfig = [
    {
        ...
        subMenu: [
            ...
            {
                key: 'concepts.invoices',
                path: '',
                title: 'Invoices',
                translateKey: 'nav.conceptsInvoices.invoices',
                icon: 'orders',
                type: NAV_ITEM_TYPE_COLLAPSE,
                authority: [ADMIN, SUPERVISOR, INVOICES_READ],
                meta: { description: { translateKey: 'nav.conceptsInvoices.invoicesDesc', label: 'Invoices & quotes management' } },
                subMenu: [
                    {
                        key: 'concepts.invoices.invoiceDashboard',
                        path: `${CONCEPTS_PREFIX_PATH}/invoices/invoice-dashboard`,
                        title: 'Dashboard',
                        translateKey: 'nav.conceptsInvoices.invoiceDashboard',
                        icon: 'orderList',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, SUPERVISOR, INVOICES_READ],
                        meta: { description: { translateKey: 'nav.conceptsInvoices.invoiceDashboardDesc', label: 'Invoice statistics overview' } },
                        subMenu: [],
                    },
                    {
                        key: 'concepts.invoices.invoiceList',
                        path: `${CONCEPTS_PREFIX_PATH}/invoices/invoice-list`,
                        title: 'Invoice List',
                        translateKey: 'nav.conceptsInvoices.invoiceList',
                        icon: 'orderList',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, SUPERVISOR, INVOICES_READ],
                        meta: { description: { translateKey: 'nav.conceptsInvoices.invoiceListDesc', label: 'View all invoices & devis' } },
                        subMenu: [],
                    },
                    {
                        key: 'concepts.invoices.invoiceCreate',
                        path: `${CONCEPTS_PREFIX_PATH}/invoices/invoice-create`,
                        title: 'New Invoice',
                        translateKey: 'nav.conceptsInvoices.invoiceCreate',
                        icon: 'orderCreate',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, SUPERVISOR, INVOICES_WRITE],
                        meta: { description: { translateKey: 'nav.conceptsInvoices.invoiceCreateDesc', label: 'Create invoice or devis' } },
                        subMenu: [],
                    },
                ],
            },
            ...
            },
            {
                ...
                icon: 'mail',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [ADMIN, SUPERVISOR, SUPPORT, USER, MAIL_READ],
            ...
            },
            {
                ...
                icon: 'chat',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [ADMIN, SUPERVISOR, SUPPORT, USER, CHAT_READ],
