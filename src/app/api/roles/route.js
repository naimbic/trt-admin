...
const DEFAULT_ROLES = [
    {
        ...
        accessRight: { users: ['write', 'read', 'delete'], products: ['write', 'read', 'delete'], configurations: ['write', 'read', 'delete'], files: ['write', 'read', 'delete'], reports: ['write', 'read', 'delete'] },
        order: 0,
    },
    {
        roleId: 'supervisor',
        ...
        accessRight: { users: ['write', 'read'], products: ['write', 'read'], configurations: ['write', 'read'], files: ['write', 'read'], reports: ['read'] },
        order: 1,
    },
    {
        roleId: 'support',
        ...
        accessRight: { users: ['read'], products: ['write', 'read'], configurations: ['read'], files: ['write', 'read'], reports: ['read'] },
        order: 2,
    },
    {
        roleId: 'user',
        ...
        accessRight: { users: [], products: ['read'], configurations: [], files: ['write', 'read'], reports: [] },
        order: 3,
    },
    {
        roleId: 'auditor',
        ...
        accessRight: { users: ['read'], products: ['read'], configurations: [], files: ['read'], reports: ['read'] },
        order: 4,
    },
    {
        roleId: 'guest',
        ...
        accessRight: { users: [], products: ['read'], configurations: [], files: [], reports: [] },
        order: 5,
    },
]
