...
const Page = () => {
    return (
        <>
            <h6>Prerequisites</h6>
            <p>
                Before getting started with trtdigital, ensure your development
            ...
            <div className="mt-8">
                ...
                <p>
                    Once you&apos;ve chosen your desired package, navigate to
                    the project&apos;s root directory (where{' '}
                    <code>package.json</code> is located) and run the following
